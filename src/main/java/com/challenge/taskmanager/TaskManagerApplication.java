...
public class TaskManagerApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Task task1 = new Task("Sleep", "Need to catch up on sleep", LocalDate.of(2020,5,2),false);
		...
		Task task3 = new Task("Do taxes", "Ive been procrastinating", LocalDate.of(2020,5,2),false);
		Task task4 = new Task("Meal prep", "Ive been craving chicken adobo", LocalDate.of(2020,5,2),false);
